...
@UsingSpring(resources = {"mtc-steps.xml"})
public class AnnotatedMTCStories extends InjectableEmbedder {

    public AnnotatedMTCStories() {
    }
    ...
    public void run() throws Throwable {
        ...
        StoryReporterBuilder reporterBuilder = new StoryReporterBuilder()
                .withCodeLocation(codeLocationFromClass(MTCStories.class)).withFailureTrace(true)
        ...
        configuration.useFailureStrategy(new FailingUponPendingStep())
                ...
                .useStoryLoader(new LoadFromClasspath(MTCStories.class))
